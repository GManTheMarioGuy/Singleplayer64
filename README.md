...
2. Clone the repo: `git clone https://github.com/GManTheMarioGuy/Singleplayer64.git`, which will create a directory `sm64-port` and then **enter** it `cd sm64-port`.
...
4. Clone the repo: `git clone https://github.com/GManTheMarioGuy/Singleplayer64.git`, which will create a directory `Singleplayer64` and then **enter** it `cd Singleplayer64`.
